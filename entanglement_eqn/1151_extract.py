...
def get_sqIneq(vc, CovM):
    ...
    n1 = abs(CovM[0, 0] * 1.0 + CovM[1, 1] * 1.0 - 0.25)  # excluding zpf
    n2 = abs(CovM[2, 2] * 1.0 + CovM[3, 3] * 1.0 - 0.25)  # excluding zpf
    ...
    ineq = ((2.0 * np.sqrt(vc.f1 * vc.f2) + (n1 + n2)) /
            (vc.f1 * (2.0 * n1 + 1.0) + vc.f2 * (2.0 * n2 + 1.0)))  # inequality equation:
...
def createCovMat(vc, vc2, power1=0, Ibx=0):
    ...
    # I1I2_2 = vc2.Varr[4, power1, Ibx] * 1.0
    # I1Q2_2 = vc2.Varr[5, power1, Ibx] * 1.0
    # Q1I2_2 = vc2.Varr[6, power1, Ibx] * 1.0
    # Q1Q2_2 = vc2.Varr[7, power1, Ibx] * 1.0
    ...
    covM = np.array([[abs(I1I1-I1I1_2) / g1 + 0.25, I1Q1 / g1, I1I2 / g12, I1Q2 / g12],
                     [I1Q1 / g1, abs(Q1Q1-Q1Q1_2) / g1 + 0.25, Q1I2 / g12, Q1Q2 / g12],
                     [I1I2 / g12, Q1I2 / g12, abs(I2I2-I2I2_2) / g2 + 0.25, I2Q2 / g2],
                     [I1Q2 / g12, Q1Q2 / g12, I2Q2 / g2, abs(Q2Q2-Q2Q2_2) / g2 + 0.25]])
    # covM = np.array([[(I1I1 - I1I1_2) / g1 + 0.25, I1Q1 / g1, (I1I2 - I1I2_2) / g12, (I1Q2 - I1Q2_2) / g12],
    #                  [I1Q1 / g1, (Q1Q1 - Q1Q1_2) / g1 + 0.25, (Q1I2 - Q1I2_2) / g12, (Q1Q2 - Q1Q2_2) / g12],
    #                  [(I1I2 - I1I2_2) / g12, (Q1I2 - Q1I2_2) / g12, (I2I2 - I2I2_2) / g2 + 0.25, I2Q2 / g2],
    #                  [(I1Q2 - I1Q2_2) / g12, (Q1Q2 - Q1Q2_2) / g12, I2Q2 / g2, (Q2Q2 - Q2Q2_2) / g2 + 0.25]])
...
vc.d1.start = 0.0
vc.d1.stop = 8.0
savename = fname+'LogN.mtx'
savename2 = fname+'ineqSq.mtx'
